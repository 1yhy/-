            ...
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr, index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" v-for="spuSaleAttrValue in spuSaleAttr.spuSaleAttrValueList"
                  ...
                  @click="changeActive(spuSaleAttrValue, spuSaleAttr.spuSaleAttrValueList, index)">{{
...
export default {
  ...
  methods: {
    changeActive(saleAttrValue, arr, index) {
      arr.forEach(item => {
        item.isChecked = '0'
      });
      saleAttrValue.isChecked = '1'
      this.skuInfo.skuSaleAttrValueList[index] = saleAttrValue
    },
    changeSkuNum(event) {
